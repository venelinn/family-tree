...
import { FamilyMemberNodeData } from './FamilyTreeChild/Family/FamilyMemberNode';
import {
  FamilyMember,
  FamilyMembers,
  FamilyRelations,
...
export function buildFamilyAndRelations(
  rawFamily: RawFamilyMember[],
  rawRelation: RawFamilyRelation[]
) {
